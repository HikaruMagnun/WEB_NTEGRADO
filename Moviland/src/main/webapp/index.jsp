      ...
      <div id="navbarBasicExample" class="navbar-menu">
        ...
        <div class="navbar-end">
          <div class="navbar-item">
            <% Cookie[] cookies = request.getCookies(); String usuario = ""; if
            (cookies != null) { for (Cookie cookie : cookies) { if
            ("user".equals(cookie.getName())) { usuario = cookie.getValue(); %>
            <h1><%=usuario + "fds"%></h1>
            <% break; } } } if (! usuario.isEmpty()) { %>
            <h1 class="navbar-item"><%=usuario%></h1>
            <% } else { %>
            <div class="buttons">
